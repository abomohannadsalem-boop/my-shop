        ...
        <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-lg">
          <div className="grid md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center p-7 md:p-12">
              {product.categories?.name && <span className="mb-3 text-sm font-medium text-blue-600">{product.categories.name}</span>}
              ...
              <div className="mt-6"><AddToCartButton product={{ id: product.id, name: product.name, price: product.price, image_url: product.image_url }} /></div>
            </div>
          </div>
        </div>
